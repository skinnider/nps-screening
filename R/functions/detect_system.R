...
if (system == 'cedar') {
  base_dir = paste0("/home/",
                    Sys.info()[["user"]],
                    "/projects/rrg-ljfoster-ab/skinnim/nps-screening")
  args$allocation = paste0('rrg-', Sys.info()[["user"]])
} else if (system == 'sockeye') {
  base_dir = "/scratch/st-ljfoster-1/nps-screening"
  args$allocation = 'st-ljfoster-1'
} else if (system == 'elasti') {
  base_dir = '/home/ubuntu/projects/rrg-ljfoster-ab/skinnim/nps-screening'
  args$allocation = 'root'
} else if (system == 'local') {
  base_dir = "~/git/nps-screening/data"
